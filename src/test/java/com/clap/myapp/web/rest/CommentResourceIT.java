...
import com.clap.myapp.repository.CommentRepository;
...
class CommentResourceIT {
    ...
    public static Comment createEntity() {
        Comment comment = new Comment().text(DEFAULT_TEXT).date(DEFAULT_DATE);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity() {
        Comment comment = new Comment().text(UPDATED_TEXT).date(UPDATED_DATE);
        return comment;
    }
