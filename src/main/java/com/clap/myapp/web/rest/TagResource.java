...
/**
 * REST controller for managing {@link com.clap.myapp.domain.Tag}.
 */
@RestController
@RequestMapping("/api")
public class TagResource {
     ...
     */
    @PutMapping("/tags/{id}")
    public ResponseEntity<Tag> updateTag(@PathVariable(value = "id", required = false) final String id, @RequestBody Tag tag)
    ...
    public ResponseEntity<Tag> partialUpdateTag(@PathVariable(value = "id", required = false) final String id, @RequestBody Tag tag)
        throws URISyntaxException {
