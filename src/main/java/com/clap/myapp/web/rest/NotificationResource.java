...
/**
 * REST controller for managing {@link com.clap.myapp.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
    ...
    public ResponseEntity<Notification> partialUpdateNotification(
        ...
        Optional<Notification> result = notificationRepository
            ...
            .map(existingNotification -> {
                ...
                if (notification.getEmisionDate() != null) {
                    existingNotification.setEmisionDate(notification.getEmisionDate());
                }
