...
export const ProjectDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="clapApplicationApp.project.delete.question">
        <Translate contentKey="clapApplicationApp.project.delete.question" interpolate={{ id: projectEntity.id }}>
