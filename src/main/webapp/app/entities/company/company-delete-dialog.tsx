...
export const CompanyDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="clapApplicationApp.company.delete.question">
        <Translate contentKey="clapApplicationApp.company.delete.question" interpolate={{ id: companyEntity.id }}>
