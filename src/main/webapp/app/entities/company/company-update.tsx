  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="clapApplicationApp.company.home.createOrEditLabel" data-cy="CompanyCreateUpdateHeading">
            <Translate contentKey="clapApplicationApp.company.home.createOrEditLabel">Create or edit a Company</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('clapApplicationApp.company.companyName')}
              ...
              />
              <ValidatedField
                label={translate('clapApplicationApp.company.taxIdNumber')}
              ...
              />
              <ValidatedField
                label={translate('clapApplicationApp.company.officeAddress')}
                id="company-officeAddress"
                name="officeAddress"
