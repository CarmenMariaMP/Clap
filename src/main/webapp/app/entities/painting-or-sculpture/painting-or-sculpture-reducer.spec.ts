...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './painting-or-sculpture.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAINTINGORSCULPTURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAINTINGORSCULPTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAINTINGORSCULPTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAINTINGORSCULPTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAINTINGORSCULPTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAINTINGORSCULPTURE actions', async () => {
      const expectedActions = [
        {
