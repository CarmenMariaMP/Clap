  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="clapApplicationApp.comment.home.createOrEditLabel" data-cy="CommentCreateUpdateHeading">
            <Translate contentKey="clapApplicationApp.comment.home.createOrEditLabel">Create or edit a Comment</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('clapApplicationApp.comment.text')}
                id="comment-text"
                name="text"
                data-cy="text"
                type="text"
              />
              <ValidatedField
                label={translate('clapApplicationApp.comment.date')}
                id="comment-date"
                name="date"
                data-cy="date"
                type="date"
