...
export const CommentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="clapApplicationApp.comment.delete.question">
        <Translate contentKey="clapApplicationApp.comment.delete.question" interpolate={{ id: commentEntity.id }}>
