...
import { getEntities as getArtisticContents } from 'app/entities/artistic-content/artistic-content.reducer';
...
export const TagUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const artisticContents = useAppSelector(state => state.artisticContent.entities);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="clapApplicationApp.tag.home.createOrEditLabel" data-cy="TagCreateUpdateHeading">
            <Translate contentKey="clapApplicationApp.tag.home.createOrEditLabel">Create or edit a Tag</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('clapApplicationApp.tag.name')} id="tag-name" name="name" data-cy="name" type="text" />
