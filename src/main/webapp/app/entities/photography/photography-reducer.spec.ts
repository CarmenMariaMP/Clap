...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHOTOGRAPHY_LIST actions', async () => {
    ...
    it('dispatches FETCH_PHOTOGRAPHY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PHOTOGRAPHY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PHOTOGRAPHY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PHOTOGRAPHY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PHOTOGRAPHY actions', async () => {
      const expectedActions = [
        {
