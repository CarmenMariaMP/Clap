...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cinema.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CINEMA_LIST actions', async () => {
    ...
    it('dispatches FETCH_CINEMA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CINEMA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CINEMA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CINEMA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CINEMA actions', async () => {
      const expectedActions = [
        {
