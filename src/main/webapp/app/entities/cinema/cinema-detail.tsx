...
export const CinemaDetail = (props: RouteComponentProps<{ id: string }>) => {
    ...
    <Row>
      <Col md="8">
        <h2 data-cy="cinemaDetailsHeading">
          <Translate contentKey="clapApplicationApp.cinema.detail.title">Cinema</Translate>
        </h2>
