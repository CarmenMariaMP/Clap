...
export const MusicDetail = (props: RouteComponentProps<{ id: string }>) => {
    ...
    <Row>
      <Col md="8">
        <h2 data-cy="musicDetailsHeading">
          <Translate contentKey="clapApplicationApp.music.detail.title">Music</Translate>
        </h2>
