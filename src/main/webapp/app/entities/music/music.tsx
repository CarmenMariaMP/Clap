...
export const Music = (props: RouteComponentProps<{ url: string }>) => {
  ...
  return (
    <div>
      <h2 id="music-heading" data-cy="MusicHeading">
        <Translate contentKey="clapApplicationApp.music.home.title">Music</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="clapApplicationApp.music.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/music/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="clapApplicationApp.music.home.createLabel">Create new Music</Translate>
          </Link>
        </div>
      </h2>
        ...
        {musicList && musicList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="clapApplicationApp.music.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="clapApplicationApp.music.genres">Genres</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {musicList.map((music, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`clapApplicationApp.MusicGenreType.${music.genres}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="clapApplicationApp.music.home.notFound">No Music found</Translate>
            </div>
          )
        )}
      </div>
