...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dance.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DANCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DANCE actions', async () => {
      const expectedActions = [
        {
