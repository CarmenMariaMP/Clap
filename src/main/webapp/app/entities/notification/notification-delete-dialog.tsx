...
export const NotificationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="clapApplicationApp.notification.delete.question">
        <Translate contentKey="clapApplicationApp.notification.delete.question" interpolate={{ id: notificationEntity.id }}>
