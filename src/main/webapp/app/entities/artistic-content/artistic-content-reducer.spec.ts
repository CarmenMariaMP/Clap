...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTISTICCONTENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ARTISTICCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ARTISTICCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ARTISTICCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ARTISTICCONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ARTISTICCONTENT actions', async () => {
      const expectedActions = [
        {
