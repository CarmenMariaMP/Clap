...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRIVACYREQUEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRIVACYREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRIVACYREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRIVACYREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRIVACYREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRIVACYREQUEST actions', async () => {
      const expectedActions = [
        {
