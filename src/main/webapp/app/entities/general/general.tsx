...
export const General = (props: RouteComponentProps<{ url: string }>) => {
  ...
  return (
    <div>
      <h2 id="general-heading" data-cy="GeneralHeading">
        <Translate contentKey="clapApplicationApp.general.home.title">Generals</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="clapApplicationApp.general.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/general/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="clapApplicationApp.general.home.createLabel">Create new General</Translate>
          </Link>
        </div>
      </h2>
        ...
        {generalList && generalList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="clapApplicationApp.general.id">ID</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="clapApplicationApp.general.home.notFound">No Generals found</Translate>
            </div>
          )
        )}
      </div>
