...
export const GeneralUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="clapApplicationApp.general.home.createOrEditLabel" data-cy="GeneralCreateUpdateHeading">
            <Translate contentKey="clapApplicationApp.general.home.createOrEditLabel">Create or edit a General</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
