...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTENTCREATOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTENTCREATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTENTCREATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTENTCREATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTENTCREATOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTENTCREATOR actions', async () => {
      const expectedActions = [
        {
