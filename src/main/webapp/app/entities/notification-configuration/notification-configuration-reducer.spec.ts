...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './notification-configuration.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTIFICATIONCONFIGURATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_NOTIFICATIONCONFIGURATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_NOTIFICATIONCONFIGURATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_NOTIFICATIONCONFIGURATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_NOTIFICATIONCONFIGURATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_NOTIFICATIONCONFIGURATION actions', async () => {
      const expectedActions = [
        {
